...
namespace NativeScanLib
{
    public class PassportParser
    {
        ...
        static PassportModel ParsePassportType1(string[] lines){
            ...
            if (documentType != "P")
            {
                System.Diagnostics.Debug.WriteLine("the scanned text is not a valid MRZ, not a valid documentType");
                return null;
            }
            ...
            try
            {
                ...
                var documentCheckDigit = line0.Substring(9, 1);
                ...
                /*Total*/
                var totalCheckDigit = line0.Substring(43, 1);
        ...
        static PassportModel ParsePassportType3(string[] lines){
            var result = new PassportModel();
            /*Type 3 passport must have 3 lines, each with a length of 30 chars*/
            if(lines.Length < 3 && CheckLenghtLines(lines, 30))
            {
                System.Diagnostics.Debug.WriteLine("the scanned text is not a valid MRZ, format not valid");
                return null;
            }
